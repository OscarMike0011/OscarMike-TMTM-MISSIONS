	...
	_tooLow = format ["<t align='center'><t size='2.2' color='#ed3b00'>Vehicle To Low</t><br/><t size='1.2' color='#9ef680'>You need to Decrease the length of the </t><br/><t size='1.5' color='#ed3b00'>Ropes</t><br/><t size='1.2' color='#9ef680'>Join Us at ts3.naksquad.net or www.naksquad.net.</t></t>"];	
	if ((ropeLength _myRope1) < 25) then {
