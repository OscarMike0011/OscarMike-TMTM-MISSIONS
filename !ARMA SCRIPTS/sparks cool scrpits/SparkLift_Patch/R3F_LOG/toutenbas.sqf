	...
	_minheight = 150;
    _tooLow = format ["<t align='center'><t size='2.2' color='#ed3b00'>TOO LOW</t><br/><t size='1.2' color='#9ef680'>You need to be above</t><br/><t size='1.5' color='#ed3b00'>%1 meters</t><br/><t size='1.2' color='#9ef680'>in order to drop the pad.</t></t>",_minheight];
