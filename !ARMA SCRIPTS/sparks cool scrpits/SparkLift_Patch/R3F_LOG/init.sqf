...
#include "R3F_LOG_ENABLE.h"
	...
	R3F_LOG_CFG_can_tow = _this select 0;
	R3F_LOG_CFG_can_be_towed = _this select 1;
	R3F_LOG_CFG_can_lift = _this select 2;
	R3F_LOG_CFG_can_be_lifted = _this select 3;
	R3F_LOG_CFG_can_transport_cargo = _this select 4;
	R3F_LOG_CFG_can_be_transported_cargo = _this select 5;
	R3F_LOG_CFG_can_be_moved_by_player = _this select 6;
