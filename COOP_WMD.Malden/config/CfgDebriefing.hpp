...
class win
{
	...
	subtitle = "Our mission continues...The War on Terror continues,";
	description = "yet it is not endless. We do not know the day of final victory, but we have seen the turning of the tide.";
	pictureBackground = "media\win.jpg";
};