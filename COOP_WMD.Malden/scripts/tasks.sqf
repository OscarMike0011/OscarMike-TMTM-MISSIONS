...
[
	...
	[0,0,0], // Task destination, can also refer to object location. Good method to use is getMarkerPos. Use objObjNull for task without location.
...
[
	...
	"wmd1",
	["Search for WMD", "Search for WMD in Larche", "marker"],
	[ObjNull],
	"CREATED",
	10,
	true,
...
[
	[true, "zeus_1", "zeus_2", "zeus_3"],
	"wmd2",
	["Search for WMD", "Search for WMD in La Trinite", "marker"],
	[ObjNull],
	"CREATED",
	10,
	true,
...
[
	[true, "zeus_1", "zeus_2", "zeus_3"],
	"wmd3",
	["Search for WMD", "Search for WMD in Dourdan", "marker"],
	[ObjNull],
	"CREATED",
	10,
	true,
...
[
	[true, "zeus_1", "zeus_2", "zeus_3"],
	"wmd4",
	["Search for WMD", "Search for WMD in Houdan", "marker"],
	[ObjNull],
	"CREATED",
	10,
	true,
...
[
	[true, "zeus_1", "zeus_2", "zeus_3"],
	"wmd5",
	["Search for WMD", "Search for WMD in Le Port #1", "marker"],
	[ObjNull],
	"CREATED",
	10,
	true,
...
[
	[true, "zeus_1", "zeus_2", "zeus_3"],
	"wmd6",
	["Search for WMD", "Search for WMD in Le Port #2", "marker"],
	[ObjNull],
	"CREATED",
	10,
	true,
