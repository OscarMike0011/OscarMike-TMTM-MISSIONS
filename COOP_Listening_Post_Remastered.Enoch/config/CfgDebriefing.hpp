...
class vic
{
	...
	subtitle = "We have survived for now"; // Subtitle below the title when the closing shot is triggered
	description = "Now what?"; // Description visible on the debriefing screen after the closing shot
