...
class pass
{
	...
	subtitle = "You successfully destroyed the prototype weapon, saving millions of lives.";
...
class fail
{
	...
	subtitle = "You failed to destroy the prototype weapon";
	description = "Next stop, the middle east. Again.";
};