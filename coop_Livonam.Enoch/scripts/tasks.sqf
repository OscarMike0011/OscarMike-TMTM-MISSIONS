...
[
	[true,"zeus_1","zeus_2", "zeus_3"],
	"hostage",
	["Kill the officer to save the Hostage", "Save the Hostage", "marker"],
	[hostage],
	"CREATED",
	2,
	true,
...
[
	[true,"zeus_1","zeus_2", "zeus_3"],
	"task_hacklaptop",
	["Getting the intel will make the mission easier", "Optional: Get intel", "marker"],
	[laptop],
	"CREATED",
	3,
	true,
