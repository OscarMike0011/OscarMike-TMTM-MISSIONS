...
linkedItems[] = {"ItemMap","ItemMicroDAGR","TFAR_anprc152","ItemCompass","TFAR_microdagr","CUP_NVG_PVS7"};

uniformItems[] = {{"RyanZombiesAntiVirusTemporary_Item",0},{"RyanZombiesAntiVirusCure_Item",0}};
vestItems[] = {};
